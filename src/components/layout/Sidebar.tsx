...
export const Sidebar: React.FC<SidebarProps> = ({
    ...
    return (
        <>
            ...
            <aside className={`
                w-full lg:w-72 xl:w-80 p-4 bg-gradient-to-b from-gray-900 via-gray-900 to-gray-800 shadow-xl overflow-y-auto flex-shrink-0 border-r border-gray-700
                ${isMobile
                    ...
                    <div className="monitor-satelital bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-4 border border-gray-700 shadow-lg">
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-3">
                                <div className={`w-10 h-10 rounded-xl flex items-center justify-center shadow-lg ${filteredFires.filter(f => f.confidence === 'high').length > 5 ? 'bg-gradient-to-br from-red-600 to-red-700' :
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="pt-3 border-t border-gray-700/50">
                                ...
                                <div className="mt-3 pt-3 border-t border-gray-700/50">
                                    ...
                                    <p className="text-xs text-gray-400 mb-3">Ayuda a mantener FIRMS activo</p>
                                    <div className="flex items-center gap-2">
                                        <a
                                            href="https://ko-fi.com/camiloquirogadev"
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="flex-1 flex items-center justify-center gap-1.5 bg-red-600/20 hover:bg-red-600/30 text-red-300 hover:text-red-200 transition-all text-xs py-2 px-3 rounded-md border border-red-600/30 group"
                                        >
                                        ...
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            className="flex-1 flex items-center justify-center gap-1.5 bg-purple-600/20 hover:bg-purple-600/30 text-purple-300 hover:text-purple-200 transition-all text-xs py-2 px-3 rounded-md border border-purple-600/30 group"
                                        >
                                            <svg className="w-4 h-4 group-hover:scale-110 transition-transform" fill="currentColor" viewBox="0 0 24 24">
